...
/bin/bash ./libtool --silent --tag=CC --mode=link emcc --bind -s BINARYEN_TRAP_MODE=clamp -s ALLOW_MEMORY_GROWTH=1 $CPPFLAGS $LDFLAGS -o utilities/magick.html utilities/magick.o MagickCore/libMagickCore-7.Q16HDRI.la MagickWand/libMagickWand-7.Q16HDRI.la
